...
function Home() {
    return (
        <div className="homeClass" style={{width:"100%"}}>
                ...
                <div>
                    <img className="text-center" style={{marginLeft:"750px", width: "10%" }} src={lowPrice}></img>
                ...
                <div>
                    <img className="text-center" style={{ marginLeft:"1100px",width: "10%" }} src={priceMatch}></img>
