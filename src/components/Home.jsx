...
function Home() {
    return (
        <div className="homeClass" style={{width:"100%"}}>
                ...
                <img className="text-center" style={{ marginLeft:"860px", width: "10%" }} src={onLine}></img>
                ...
                <div>
                    <img className="text-center" style={{marginLeft:"580px", width: "10%" }} src={lowPrice}></img>
                    <img className="text-center" style={{ marginLeft:"350px",width: "10%" }} src={basket}></img>
                    <p></p>
                     <p style={{ textAlign:"center", fontFamily:"cursive",color:"green"}}><b>Price matched against all major supermarkets. </b></p> 
                </div>

                <div>
                    <img className="text-center" style={{ marginLeft:"860px",width: "10%" }} src={priceMatch}></img>
